    ...
    <div className={`${styles.formBox} ${styles.register}`}>
      <form onSubmit={handleSubmit}>
        ...
        <div className={styles.socialBtns}>
          ...
          <button type="button" className={`${styles.socialBtn} ${styles.facebook}`} onClick={() => handleOAuth("facebook")}>
          ...
          <button type="button" className={`${styles.socialBtn} ${styles.discord}`} onClick={() => handleOAuth("discord")}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="#fff">
          ...
          <button type="button" className={`${styles.socialBtn} ${styles.instagram}`} onClick={() => handleOAuth("instagram")}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="#fff">
